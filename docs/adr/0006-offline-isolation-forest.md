...
- v0.7 adds a local per-machine registry, v0.9 adds pre-deserialization Ed25519
  verification, v0.10 adds post-training anomaly-rate and PSI gates, v0.12 stores their
  immutable evidence, and v0.13 adds explicit atomic promotion and rollback. Human
  approval, labelled outcome evaluation, and key rotation remain required before
  production use.

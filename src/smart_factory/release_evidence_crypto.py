"""Encrypt and recover private release evidence with an external RSA trust anchor."""
...
def public_key_fingerprint_from_path(public_key_path: Path) -> str:
...
def encrypt_release_evidence(
    ...
    envelope = {
        ...
        "recipient_key_sha256": public_key_fingerprint(public_key),
...
def decrypt_release_evidence(
    ...
    *,
    ...
    if envelope.get("recipient_key_sha256") != public_key_fingerprint(private_key.public_key()):

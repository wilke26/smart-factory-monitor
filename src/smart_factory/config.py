...
_AUDIT_KEY_ID_PATTERN = re.compile(r"^[0-9a-f]{64}$")
...
class AuditCheckpointSettings:
    ...
    def from_env(
        ...
        *,
        ...
        if require_keyring and trusted_root_key_id is None:
        ...
        if (
            allow_colocated_trusted_root
            and trusted_root_key_id_path is not None
            and (
